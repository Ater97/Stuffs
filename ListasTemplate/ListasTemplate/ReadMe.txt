========================================================================
    APLICACIÓN: ListasTemplate Información general del proyecto
========================================================================

AppWizard ha creado esta aplicación ListasTemplate.  

Este archivo contiene un resumen de lo que encontrará en cada uno de los archivos que constituyen la aplicación ListasTemplate.

ListasTemplate.vcxproj
...
ListasTemplate.vcxproj.filters
