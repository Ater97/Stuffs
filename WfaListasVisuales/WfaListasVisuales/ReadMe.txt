========================================================================
    APLICACIÓN: Información general del proyecto WfaListasVisuales
========================================================================

AppWizard ha creado esta aplicación WfaListasVisuales.  

Este archivo incluye un resumen acerca del contenido de los archivos que
constituyen su aplicación WfaListasVisuales.

WfaListasVisuales.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado WfaListasVisuales.pch y un archivo de 
